...
export default function PropertyFormSheet({ open, onClose, property }: Props) {
  ...
  // Reset billingCycle when type changes so a stale value isn't sent
  useEffect(() => {
    ...
    <Sheet open={open} onOpenChange={onClose}>
      <SheetContent className="!max-w-[800px] !w-[90vw] overflow-y-auto p-6 sm:p-8">
        ...
        >
          ...
          {/* Residential subtype — only for RESIDENTIAL_HOUSE */}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>
                Owner / Agent <span className="text-destructive">*</span>
              </Label>
              <Select
          ...
          {/* Rental terms — only shown when relevant */}
